...
<body>
    ...
    <div class="login-register">
        <a href="customerCreateTransaction.jsp" class="button">Create</a>
    </div>
    ...
    <table id="transactionDisplay">
        ...
        <% for (Transaction transaction : transactionList) {
            if (transaction.getAccount().getUsername().equals((Account.getAccount((String)session.getAttribute("sessAccUser"))).getUsername())) {
                out.println("<tr>" + 
